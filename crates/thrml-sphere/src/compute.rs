...
//!
//! This module re-exports the core compute abstractions from `thrml-core`
//! and provides sphere-specific extensions:
//!
...
//!
//! ```rust,ignore
//! use thrml_sphere::{ComputeBackend, OpType, HybridConfig};
//!
...
//! ```
//!
//! See `thrml_core::compute` for full documentation of core types.
